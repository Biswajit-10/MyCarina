...
public class Test01 implements IAbstractTest, IMobileUtils{
	
	@Test()
	public void test002() {

		DriverHelper driverHelper = new DriverHelper(getDriver());
		ExtendedWebElement btn9 = driverHelper.findExtendedWebElement(By.id("com.miui.calculator:id/btn_9_s"));
	    ...
	    multiply.click();
		ExtendedWebElement btn6 = driverHelper.findExtendedWebElement(By.id("com.miui.calculator:id/btn_6_s"));
		btn6.click();
